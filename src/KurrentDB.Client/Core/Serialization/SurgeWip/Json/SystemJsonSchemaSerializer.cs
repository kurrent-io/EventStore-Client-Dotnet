...
namespace Kurrent.Surge.Schema.Serializers.Json;
...
public class SystemJsonSchemaSerializer : SerializerBase {
    public override SchemaDataFormat SchemaDataFormat => SchemaDataFormat.Json;

    public SystemJsonSchemaSerializer(SystemJsonSchemaSerializerOptions? options = null, SchemaRegistry? registry = null) : base(registry) {
